...
public class DbmDiff implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = new CommandLine(new DbmDiff()).execute(args);
...
//                        InternalDiffChangelogCommandStep.TARGET_DATABASE_ARG, targetDatabase).addArgumentValue(InternalDiffChangelogCommandStep
//                        .SNAPSHOT_TYPES_ARG,
...
//                        InternalDiffChangelogCommandStep.CHANGELOG_FILE_ARG, outputFileArg).addArgumentValue(InternalDiffChangelogCommandStep
